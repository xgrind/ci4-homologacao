...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <script
        ...
        crossorigin="anonymous"></script>
    <script
        src="https://cdn.jsdelivr.net/npm/@editorjs/header@latest"
        crossorigin="anonymous"></script>
    <script
        src="https://cdn.jsdelivr.net/npm/@editorjs/nested-list@latest"
        crossorigin="anonymous"></script>
    <script
        src="https://cdn.jsdelivr.net/npm/@editorjs/checklist@latest"
        crossorigin="anonymous"></script>
    <script
        src="https://cdn.jsdelivr.net/npm/@editorjs/code@latest"
        crossorigin="anonymous"></script>
    <script
        src="https://cdn.jsdelivr.net/npm/@editorjs/delimiter@latest"
        crossorigin="anonymous"></script>
    <script
        src="https://cdn.jsdelivr.net/npm/@editorjs/table@latest"
        crossorigin="anonymous"></script>
    <script
        src="https://cdn.jsdelivr.net/npm/@editorjs/quote@latest"
        crossorigin="anonymous"></script>
    ...
    <?= $this->renderSection('tabulator') ?>

    <?= $this->renderSection('editorjs') ?>
</body>
